...
public class CommonUtils {
	...
	public static void runFlow(String[] flowSteps, String uuid, String inputColumns, String outputColumns, String train_data_path, String test_data_path){
...
//		    ,{"key":-9,"text":"Feature Selection", "loc":"70 -650"},{"key":-10,"text":"Parameter Setting", "loc":"100 -650"}];
		...
		for(String stepX : flowSteps1){
			...
			if(stepX.equals("-2") && flag==0){ // END BLOCK
				setConsoleLog(uuid,"status","The experiment completed successfully.");
				flag=1;
			}
			if(stepX.equals("-2") && flag==1){ // BOOSTED DECISION TREE
			...
			if(stepX.equals("-3")){ // DECISION TREE
			...
			if(stepX.equals("-4")){ // GRADIENT BOOSTING
